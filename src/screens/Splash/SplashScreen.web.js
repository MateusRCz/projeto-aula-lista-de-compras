...
import Lottie from 'lottie-react'; // IMPORT WEB
        ...
        <Pressable style={{ flex: 1 }} onPress={handleEnter}>
          <View style={{ alignItems: 'center', justifyContent: 'center', flex: 1 }}>
            <Lottie
              ...
              loop style={{ width: 130, height: 130, marginTop: 45 }}
            />
            <Text style={styles.title}>Bem-vindo!</Text>
            <Text style={styles.subtitle}>Arraste para cima ou toque na tela</Text>
            <Lottie
              animationData={require("../../assets/arrow-up.json")}
              loop style={{ width: 60, height: 60, marginTop: 18 }}
            />
          </View>
        </Pressable>
      </Animated.View>
